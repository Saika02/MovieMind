...
COMMENT ON TABLE ratings IS '评分';
COMMENT ON COLUMN ratings.id IS '评分主键';
COMMENT ON COLUMN ratings.user_id IS '评分用户';
COMMENT ON COLUMN ratings.movie_id IS '被评分电影';
COMMENT ON COLUMN ratings.score IS '评分值';
COMMENT ON COLUMN ratings.is_deleted IS '是否删除';
COMMENT ON COLUMN ratings.created_at IS '创建时间';
COMMENT ON COLUMN ratings.updated_at IS '更新时间';
```
...
COMMENT ON COLUMN comments.user_id IS '评论用户';
COMMENT ON COLUMN comments.movie_id IS '评论电影';
COMMENT ON COLUMN comments.content IS '评论内容';
COMMENT ON COLUMN comments.is_deleted IS '是否删除';
...
COMMENT ON COLUMN favorites.type IS '收藏类型枚举';
